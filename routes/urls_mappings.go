...
func MapUrls(app *fiber.App) {
	...
	micro.Post("/TestExecution/:id/files", middleware.DeserializeUser, handlers.UploadFileToCase)
	...
	micro.Post("/project/:id/SuiteExecution", middleware.DeserializeUser, handlers.CreateSuite)
	...
	micro.Post("/project/:id/TestExecution", middleware.DeserializeUser, handlers.CreateCase)
